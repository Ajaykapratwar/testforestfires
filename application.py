...
ridge_model = pickle.load(open('E:\\ML\\Step By Step Project Implementation\\forest-fire\\models\\ridge.pkl', 'rb'))
standard_scaler = pickle.load(open('E:\\ML\\Step By Step Project Implementation\\forest-fire\\models\\scaler.pkl', 'rb'))
